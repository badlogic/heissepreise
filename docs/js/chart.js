...
!(function (t, e) {
    ...
    class bt {
        ...
        _update(t = Date.now()) {
            ...
            this._charts.forEach((i, s) => {
                ...
                for (; a >= 0; --a)
                    (o = n[a]),
                        o._active ? (o._total > i.duration && (i.duration = o._total), o.tick(t), (r = !0)) : ((n[a] = n[n.length - 1]), n.pop());
        ...
        constructor(t) {
            ...
            "object" === e
                ...
                : "string" === e &&
                  ...
                  "#" === s[0] &&
                      (4 === o || 5 === o
                          ? (n = { r: 255 & (17 * St[s[1]]), g: 255 & (17 * St[s[2]]), b: 255 & (17 * St[s[3]]), a: 5 === o ? 17 * St[s[4]] : 255 })
                          : (7 !== o && 9 !== o) ||
                            (n = {
                                r: (St[s[1]] << 4) | St[s[2]],
                                g: (St[s[3]] << 4) | St[s[4]],
        ...
        [
            function (t) {
                t.set("animation", {
                    ...
                    t.set("animations", { colors: { type: "color", properties: ie }, numbers: { type: "number", properties: ee } }),
    ...
    function we(t, e, i, s) {
        ...
        (h = Math.max(0, h - o.width)),
            ...
            h && !c && (c = Me(h / 2));
        return (
            (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && ((c = l.height), (h = Me(Math.floor(c * s)))), { width: h, height: c }
        );
    }
    function ke(t, e, i) {
        const s = e || 1,
    ...
    function $e(t, e, i, s) {
        ...
        return new Proxy(a, {
            ...
            getOwnPropertyDescriptor: (e, i) =>
                e._descriptors.allKeys ? (Reflect.has(t, i) ? { enumerable: !0, configurable: !0 } : void 0) : Reflect.getOwnPropertyDescriptor(t, i),
    ...
    function Ye(t, e = { scriptable: !0, indexable: !0 }) {
        ...
        return { allKeys: n, scriptable: i, indexable: s, isScriptable: S(i) ? i : () => i, isIndexable: S(s) ? s : () => s };
    }
    ...
    const ci = (t) => 0 === t || 1 === t,
        ...
        ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * O) / i) + 1,
            ...
            easeInOutExpo: (t) => (ci(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
    ...
    function Li(t) {
        return "angle" === t ? { between: Z, compare: K, normalize: G } : { between: tt, compare: (t, e) => t - e, normalize: (t) => t };
    }
            ...
            ? (function (t, e, i, s) {
                  ...
                  for (const t of e) {
                      ...
                      for (u = d + 1; u <= t.end; u++) {
                          const r = i[u % l];
                          (e = Vi(
                              s.setContext(Ci(n, { type: "segment", p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a }))
                          )),
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t
                ? ((function (t, e) {
                      ...
                      if (
                          ((t[hs] = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }),
    ...
    class Js extends Hs {
        ...
        fit() {
            ...
            if (o) {
                ...
                if (
                    (a ? ((t.width = this.maxWidth), (t.height = Ks(n) + o)) : ((t.height = this.maxHeight), (t.width = Ks(n) + o)),
                    ...
                    e.drawOnChartArea && a({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                        e.drawTicks &&
                            a(
                                { x: t.tx1, y: t.ty1 },
                                { x: t.tx2, y: t.ty2 },
                                { color: t.tickColor, width: t.tickWidth, borderDash: t.tickBorderDash, borderDashOffset: t.tickBorderDashOffset }
                            );
                }
        }
        drawBorder() {
        ...
        drawTitle() {
            ...
            We(t, i.text, 0, 0, a, { color: i.color, maxWidth: u, rotation: f, textAlign: Zs(l, e, s), textBaseline: "middle", translation: [c, d] });
        }
        draw(t) {
    ...
    class On {
        ...
        constructor(t, e) {
            ...
            (this.id = i()),
                ...
                (Pn[this.id] = this),
                r && l
                    ? (xt.listen(this, "complete", wn), xt.listen(this, "progress", kn), this._initialize(), this.attached && this.update())
        ...
        _resize(t, e) {
            ...
            (this.width = o.width),
                ...
                (this._aspectRatio = this.aspectRatio),
                ke(this, a, !0) &&
                    (this.notifyPlugins("resize", { size: o }), d(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
        }
        ensureScalesHaveIDs() {
        ...
        _updateVisibility(t, e, i) {
            ...
            k(e)
                ...
                : (this.setDatasetVisibility(t, i), o.update(n, { visible: i }), this.update((e) => (e.datasetIndex === t ? s : void 0)));
        }
        hide(t, e) {
    ...
    function Vn(t, e, i, s) {
        ...
        "middle" === n &&
            i &&
            ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Bn(c, a, r, l)] = !0), (n = h))),
            (o[Bn(n, a, r, l)] = !0),
            (t.borderSkipped = o);
    }
    function Bn(t, e, i, s) {
    ...
    var $n = Object.freeze({
        ...
        BarController: class extends Ws {
            ...
            static overrides = {
                scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } },
            };
            parsePrimitiveData(t, e, i, s) {
                return zn(t, e, i, s);
            }
            ...
            _getStacks(t, e) {
                ...
                for (const i of n)
                    if (
                        (void 0 === e || !r(i)) &&
                        ((!1 === o || -1 === a.indexOf(i.stack) || (void 0 === o && void 0 === i.stack)) && a.push(i.stack), i.index === t)
                    )
                        break;
            ...
            updateElements(t, e, i, s) {
                ...
                for (let d = e; d < e + i; d++) {
                    ...
                    (u.skip = isNaN(f) || isNaN(g)),
                        l && ((u.options = r || this.resolveDataElementOptions(d, e.active ? "active" : s)), n && (u.options.radius = 0)),
    ...
    function Yn(t, e, i, s) {
        ...
        return { outerStart: r(n.outerStart), outerEnd: r(n.outerEnd), innerStart: J(n.innerStart, 0, a), innerEnd: J(n.innerEnd, 0, a) };
    }
    function Un(t, e, i, s) {
    ...
    function Xn(t, e, i, s, n, o) {
        ...
        const p = (g - Math.max(0.001, g * d - i / C) / d) / 2,
            m = l + p + f,
            b = n - p - f,
            { outerStart: x, outerEnd: _, innerStart: y, innerEnd: v } = Yn(e, u, d, b - m),
            M = d - x,
            w = d - _,
            k = m + x / M,
            S = b - _ / w,
        ...
        eo && !e.options.segment
            ...
            : (function (t, e, i, s) {
                  const { segments: n, options: o } = e,
                      a = to(e);
                  for (const r of n) Kn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, s);
    }
    class so extends Hs {
        static id = "line";
        ...
        draw(t, e, i, s) {
            ...
            (this.points || []).length && n.borderWidth && (t.save(), io(t, this, i, s), t.restore()),
        ...
        const e = oo(t),
            ...
            n = (function (t, e, i) {
                const s = t.options.borderWidth,
                    n = t.borderSkipped,
                    o = Mi(s);
                return { t: ao(n.top, o.top, 0, i), r: ao(n.right, o.right, 0, e), b: ao(n.bottom, o.bottom, 0, i), l: ao(n.left, o.left, 0, e) };
            })(t, i / 2, s / 2),
            a = (function (t, e, i) {
    ...
    var uo = Object.freeze({
        ...
        BarElement: class extends Hs {
            ...
            draw(t) {
                ...
                t.save(),
                    (o.w === n.w && o.h === n.h) ||
                        (t.beginPath(), a(t, co(o, e, n)), t.clip(), a(t, co(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
                    t.beginPath(),
                    a(t, co(n, e)),
                    (t.fillStyle = s),
                    t.fill(),
        ...
        PointElement: class extends Hs {
            ...
            draw(t, e) {
                ...
                this.skip ||
                    ...
                    ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Le(t, i, this.x, this.y));
            }
            getRange() {
                const t = this.options || {};
    ...
    function fo(t, e, i, s) {
        const n = t.indexOf(e);
        if (-1 === n)
            return ((t, e, i, s) => ("string" == typeof e ? ((i = t.push(e) - 1), s.unshift({ index: i, label: e })) : isNaN(e) && (i = null), i))(
                t,
                e,
                i,
                s
    ...
    class mo extends Js {
        ...
        buildTicks() {
            ...
            const n = (function (t, e) {
                ...
                for (
                    b &&
                    (u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, po(a, y, t)) && D++) : M < a && D++);
                    D < k;
                    ++D
                ) {
            ...
            return (
                ...
                t.reverse ? (n.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)),
                n
            );
        }
        configure() {
        ...
        determineDataLimits() {
            ...
            (this.min = a(t) ? Math.max(0, t) : null),
                ...
                this._zero &&
                    ...
                    !a(this._userMin) &&
                    (this.min = t === _o(this.min, 0) ? _o(this.min, -1) : _o(this.min, 0)),
    ...
    class Lo extends mo {
        ...
        drawBackground() {
            ...
            if (t) {
                ...
                i.save(),
                    i.beginPath(),
                    To(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                    i.closePath(),
                    (i.fillStyle = t),
                    i.fill(),
                    i.restore();
                ...
                (e.pointLabels.display &&
                    (function (t, e) {
                        ...
                        for (let n = e - 1; n >= 0; n--) {
                            ...
                            We(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, { color: o.color, textAlign: h, textBaseline: "middle" });
                        }
                    })(this, o),
                s.display &&
    ...
    function zo(t, e) {
        ...
        return (
            ...
            null === l ? null : (o && (l = "week" !== o || (!W(r) && !0 !== r) ? i.startOf(l, o) : i.startOf(l, "isoWeek", r)), +l)
        );
    }
    function Fo(t, e, i, s) {
        const n = Ro.length;
        ...
        buildTicks() {
            ...
            return (
                (this._unit =
                    e.unit ||
                    (i.autoSkip
                        ? Fo(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
                        : (function (t, e, i, s, n) {
    ...
    function Wo(t, e, i) {
        let s,
            ...
            l = t.length - 1;
        i
            ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = it(t, "pos", e)), ({ pos: s, time: o } = t[r]), ({ pos: n, time: a } = t[l]))
            : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = it(t, "time", e)), ({ time: s, pos: o } = t[r]), ({ time: n, pos: a } = t[l]));
        const h = n - s;
        ...
        CategoryScale: class extends Js {
            ...
            parse(t, e) {
                ...
                return ((t, e) => (null === t ? null : J(Math.round(t), 0, e)))(
                    (e = isFinite(e) && i[e] === t ? e : fo(i, t, l(e, t), this._addedLabels)),
                    i.length - 1
                );
            }
            determineDataLimits() {
            ...
            getPixelForValue(t) {
                return (
                    "number" != typeof t && (t = this.parse(t)), null === t ? NaN : this.getPixelForDecimal((t - this._startValue) / this._valueRange)
                );
            }
            getPixelForTick(t) {
                const e = this.ticks;
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                let { start: d, count: u } = (function (t, e) {
                    ...
                    return (
                        l && (n = J(it(e, o.axis, a).lo, 0, i - 1)), (s = h ? J(it(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s }
                    );
                })(l, h);
    ...
    function ia(t, e) {
        ...
        return (
            ...
            i.length ? new so({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
        );
    }
    function sa(t) {
        return t && !1 !== t.fill;
            ...
            if (e.getPointPositionForValue)
                return (function (t) {
                    ...
                    if (s.grid.circular) {
                        ...
                        return new la({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(r) });
                    }
        ...
        s &&
            ...
            (function (t, e) {
                ...
                t.save(),
                    "x" === l &&
                        o !== n &&
                        (da(t, s, a.top), ua(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), da(t, s, a.bottom));
                ua(t, { line: i, target: s, color: o, scale: r, property: l }), t.restore();
                ...
                for (const t of s) {
                    ...
                    for (const e of h) {
                        const s = Qo(i, o[e.start], o[e.end], e.loop),
                            r = Ri(t, n, s);
                        for (const t of r)
                            a.push({ source: t, target: e, start: { [i]: ea(l, s, "start", Math.max) }, end: { [i]: ea(l, s, "end", Math.min) } });
                    }
                }
                return a;
            })(i, s, n);
    ...
    class ba extends Hs {
        ...
        _draw() {
            const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
                ...
                u = d / 2;
            let f;
            this.drawTitle(), (s.textAlign = r.textAlign("left")), (s.textBaseline = "middle"), (s.lineWidth = 0.5), (s.font = h.string);
            ...
            this.legendItems.forEach((y, v) => {
                ...
                r.setWidth(this.width),
                    b
                        ? v > 0 && S + k + c > this.right && ((P = f.y += _), f.line++, (S = f.x = ft(n, this.left + c, this.right - i[f.line])))
                        : v > 0 &&
                          P + _ > this.bottom &&
                          ((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + x + c, this.bottom - e[f.line].height)));
                if (
                    ((function (t, e, i) {
                        ...
                        if (
                            ...
                            const a = { radius: (p * Math.SQRT2) / 2, pointStyle: i.pointStyle, rotation: i.rotation, borderWidth: n },
                                l = r.xPlus(t, g / 2);
                            ...
                            const o = e + Math.max((d - p) / 2, 0),
                                ...
                                l = wi(i.borderRadius);
                            s.beginPath(),
                                Object.values(l).some((t) => 0 !== t) ? He(s, { x: a, y: o, w: g, h: p, radius: l }) : s.rect(a, o, g, p),
                                s.fill(),
                                0 !== n && s.stroke();
                        }
                        s.restore();
                    ...
                    (function (t, e, i) {
                        We(s, i.text, t, e + m / 2, h, { strikethrough: i.hidden, textAlign: r.textAlign(i.textAlign) });
                    })(r.x(S), P, y),
                    b)
                )
                    f.x += k + c;
    ...
    class ya extends Hs {
        ...
        _drawArgs(t) {
            ...
            return (
                this.isHorizontal()
                    ...
                    : ("left" === o.position ? ((l = i + t), (h = ft(a, s, e)), (c = -0.5 * C)) : ((l = n - t), (h = ft(a, e, s)), (c = 0.5 * C)),
                      (r = s - e)),
        ...
        draw() {
            ...
            We(t, e.text, 0, 0, i, { color: e.color, maxWidth: a, rotation: r, textAlign: ut(e.align), textBaseline: "middle", translation: [n, o] });
        }
    }
    var va = {
        id: "title",
    ...
    class Fa extends Hs {
        ...
        getContext() {
            return (
                this.$context ||
                (this.$context =
                    ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Ci(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
            );
            var t, e, i;
        }
        getTitle(t, e) {
